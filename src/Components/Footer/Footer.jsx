...
import moreinLogo from '../../assets/Images/moreinLogo.jpg'
...
const Footer = () => {
  return (
    ...
    <div className="w-full max-w-6xl mx-auto px-5">
      ...
      <img src={moreinLogo} width={50} height={50} alt="Logo" />
      <span className="text-3xl font-semibold">More In</span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="content">
          ...
          <div className="flex space-x-4 mt-4">
            <Link
              to="https://www.facebook.com/morein.Eg"
              target="_blank"
            ...
            <Link
              to="https://www.instagram.com/more_in_eg/#"
              target="_blank"
              className="p-3 bg-white text-mainColor rounded-full hover:bg-gray-300 transition duration-300"
            >
        ...
        {["Home", "Menu", "Contact Us"].map((page, index) => (  
          <li key={index}>
            <NavLink
              to={page === "Menu" ? "MoreIn_menu" : page.toLowerCase().replace(" ", "_")}
              className={({ isActive }) =>
      ...
      <Link to="https://food2go.online/" target="_blank" className="flex items-center justify-center gap-2 text-sm mt-2 border-t border-white pt-4">
        ...
        <h1 className="text-white font-semibold text-lg">More In</h1>
        </Link>
    </div>
  </div>
  );
